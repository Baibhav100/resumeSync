      ...
      <div className="hidden lg:flex w-1/2 flex-col justify-between p-12 bg-slate-900 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg mb-20">
          <h1 className="text-5xl font-extrabold text-white leading-tight mb-6 font-heading">
            Land your next role with an optimized <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">ATS Resume</span>.
          </h1>
          <p className="text-slate-300 text-lg leading-relaxed font-light">
            Stop guessing what employers want. Upload your experience once, paste the job description, and our AI tailors your resume instantly to beat the Applicant Tracking Systems.
          </p>
          ...
          <div className="mt-12 flex items-center gap-4">
            <div className="flex -space-x-3">
              ...
              <div className="w-10 h-10 rounded-full border-2 border-slate-900 bg-slate-400 bg-center bg-cover" style={{backgroundImage: "url('https://i.pravatar.cc/100?img=33')"}}></div>
            ...
            <p className="text-sm text-slate-400 font-medium">Trusted by professionals worldwide.</p>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 relative">
        <div className="w-full max-w-md">
          ...
          <div className="mb-10 text-center lg:text-left">
            <h2 className="text-3xl font-bold text-slate-900 mb-2 font-heading tracking-tight">Welcome back</h2>
            <p className="text-slate-500 text-sm sm:text-base">Please enter your credentials to access your dashboard.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                ...
                <Link to="/forgot-password" size="sm" className="text-sm font-medium text-blue-600 hover:text-blue-500 transition-colors">Forgot password?</Link>
              </div>
              <input
                type="password"
                name="password"
            ...
            <div className="relative py-6 flex items-center">
              ...
              <span className="flex-shrink mx-4 text-slate-400 text-xs font-semibold uppercase tracking-wider">New to platform?</span>
              <div className="flex-grow border-t border-slate-200"></div>
            </div>

            <Link to="/register" className="w-full flex justify-center py-3.5 px-4 bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 rounded-xl font-semibold transition-colors active:scale-[0.98]">
              Create an account
            </Link>
          </form>
        </div>
